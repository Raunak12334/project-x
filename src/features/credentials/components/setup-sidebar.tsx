                  ...
                  <span
                    className={cn(
                      ...
                      isActive
                        ...
                        : "bg-slate-200 scale-75 group-hover:bg-slate-300",
                    )}
                  />
      ...
      <div className="mt-auto">
        <div className="p-6 rounded-[32px] bg-slate-900 text-white shadow-2xl shadow-slate-900/10 relative overflow-hidden group">
          ...
          <div className="relative z-10">
            ...
            <button
              type="button"
              className="w-full py-2.5 bg-white text-slate-900 rounded-xl text-xs font-black hover:bg-slate-50 transition-colors shadow-sm"
            >
              REQUEST ACCESS
            </button>
          </div>
